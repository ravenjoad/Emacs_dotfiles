...
(use-package emacs
  ...
  ;; value of 4096 is a bit small; use 4M in this case, if Linux allows us.
  ;; This improves EVERYTHING that Emacs calls a read() on: sockets, PTYs,
  ;; pipes, which means JSON connections for LSP get better too.
