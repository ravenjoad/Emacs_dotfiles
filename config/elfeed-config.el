...
(use-package elfeed
  ...
  (elfeed-feeds '(("https://raven.hallsby.com/feed.xml" personal blog)
                  ...
                  ("https://shepherding.services/news/feed.xml" gnu guile guix shepherd)
                  ...
                  ("https://justine.lol/rss.xml" systems compilers blog)
                  ("https://yazandaba.hashnode.dev/rss.xml" compilers blog)
                  ("https://cfallin.org/feed.xml" compilers blog)
                  ("https://www.cs.cornell.edu/~asampson/blog.xml" languages compilers hardware blog)
                  ("https://sibexi.co/atom.xml" systems blog)
                  ...
                  ("https://www.jamescherti.com/feed" emacs git linux blog)
                  ("https://rust-glancer.github.io/atom.xml" languages systems rust compilers)
